...
import { assertNoContamination, findContamination, ContaminationError, } from '../../../packages/core/src/contamination.ts';
describe('assertNoContamination', () => {
    ...
    it('throws with correct target info', () => {
        ...
        try {
            ...
            expect(e.target).toBe('v3');
            expect(e.found).toBe('$$type');
        }
    });
...
//# sourceMappingURL=contamination.test.js.map