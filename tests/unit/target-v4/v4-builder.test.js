...
import { runGuards, findContamination, EMPTY_DESIGN_TOKEN_SET } from '../../../packages/core/src/index.ts';
...
describe('V4 Builder', () => {
    ...
    it('section has styles with $$type wrapped props', () => {
        ...
        const bgProp = cls.variants[0].props.background_color;
...
//# sourceMappingURL=v4-builder.test.js.map