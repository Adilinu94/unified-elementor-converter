...
import { loadState, saveState, markPhase, createInitialState, } from '../../../packages/core/src/pipeline-state.ts';
describe('pipeline-state', () => {
    ...
    it('createInitialState has correct shape', () => {
        const state = createInitialState('v4', {
            type: 'html-export',
            url: undefined,
            xmlPath: undefined,
        });
...
//# sourceMappingURL=pipeline-state.test.js.map