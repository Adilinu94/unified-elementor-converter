...
import { RateLimiter, createDomainRateLimiter, normalizeImageUrl, buildManifest, } from '@elconv/extractors';
...
describe('buildManifest', () => {
    it('aggregates totals', () => {
        const manifest = buildManifest('https://example.com', [{ local_path: 'a.jpg', mime: 'image/jpeg', filesize: 1000, downloaded_at: '' }], [{ local_path: 'b.woff2', url: '', type: 'woff2', filesize: 500, downloaded_at: '' }], [{ local_path: 'c.svg', kind: 'inline', filesize: 200 }]);
