...
import { DEFAULT_CONFIG, CONFIG_FILENAME, parseConfigYaml, serializeConfigYaml, mergeConfigs, validateConfig, } from '@elconv/core';
describe('Config System', () => {
    ...
    describe('parseConfigYaml', () => {
        ...
        it('parses nested objects', () => {
            ...
            expect(result.project.defaultTarget).toBe('v4');
        });
        it('parses arrays', () => {
            const yaml = `items:\n  - one\n  - two\n  - three`;
            const result = parseConfigYaml(yaml);
    ...
    describe('serializeConfigYaml', () => {
        ...
        it('round-trips config', () => {
            ...
            expect(parsed.project.defaultTarget).toBe('v3');
        });
    });
