...
import { mapWidgetType, mapElType, convertSettings, generateStyleClass, convertElement, bridgeV3toV4, validateBridgeOutput, resetBridgeIds, } from '@elconv/target-v4';
describe('Bridge V3→V4', () => {
    ...
    describe('convertElement', () => {
        ...
        it('generates new IDs when preserveIds=false', () => {
            const v3 = { id: 'orig', elType: 'section' };
