...
import {
  ...
  buildAuthHeader,
  type WpTarget,
} from '../../../packages/mcp/src/targets.ts';
...
describe('targets', () => {
  ...
  it('saveTargets + loadTargets preserves multiple targets', () => {
    const store = {
      targets: {
        site1: { mcpEndpoint: 'https://a.test', authEnv: 'A', defaultTemplate: 'default' as const },
        site2: { mcpEndpoint: 'https://b.test', authEnv: 'B', defaultTemplate: 'elementor_canvas' as const },
      },
    };
