...
import { runPreflight, formatPreflightReport, type PreflightReport } from '../../../packages/mcp/src/preflight.ts';
import { buildV3Tree } from '../../../packages/target-v3/src/builder.ts';
import { buildV4Tree } from '../../../packages/target-v4/src/builder.ts';
import type { SourceSpec } from '../../../packages/core/src/types.ts';
